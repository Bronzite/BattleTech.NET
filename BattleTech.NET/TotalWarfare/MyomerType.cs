...
{
    public class MyomerType:ITechBase,IAliasable
    {
        public MyomerType() {
            Name = "Standard";
            MassFraction = 0;
        ...
        public static List<MyomerType> GetCanonicalMyomerTypes ()
        {
            ...
            retval.Add(new MyomerType("MASC", TECHNOLOGY_BASE.INNERSPHERE, 0.05, 0.05, 0) { MASCRunSpeedMultiplier = 2,MASCRollTrack = new int[] { 3, 4, 6, 10, 13 } }
            .AddAlias("ISMASC") as MyomerType) ; //TM52, TW137
            retval.Add(new MyomerType("MASC (Clan)", TECHNOLOGY_BASE.CLAN, 0.04, 0.04, 0) { MASCRunSpeedMultiplier= 2,MASCRollTrack = new int[] { 3, 4, 6, 10, 13 } }
            .AddAlias("CLMASC")
            .AddAlias("MASC") as MyomerType); //TM52, TW137
            retval.Add(new MyomerType("TSM", TECHNOLOGY_BASE.INNERSPHERE, 0, 0, 6) { HeatActivationThreshold = 9, BattleMechWalkingMPIncrease = 2, BattleMechPhysicalAttackDamageMultipler = 2 }
